...
def get_args(rest_args):
    ...
    parser.add_argument('--exp_label', default='fansrl', help='label (typically name of method)')
    ...
    parser.add_argument('--kl_pri_state_weight', type=float, default=0.1, help='weight for the KL term')
    parser.add_argument('--kl_dyn_state_weight', type=float, default=0.1, help='weight for the KL term')
    parser.add_argument('--kl_pri_rew_weight', type=float, default=0.1, help='weight for the KL term')
    parser.add_argument('--kl_dyn_rew_weight', type=float, default=0.1, help='weight for the KL term')
    ...
    parser.add_argument('--rew_rec_loss_coeff', type=float, default=1.0, help='weight for state loss (vs reward loss)')
    parser.add_argument('--rew_pred_loss_coeff', type=float, default=1.0, help='weight for state loss (vs reward loss)')
    ...
    parser.add_argument('--state_rec_loss_coeff', type=float, default=1.0, help='weight for state loss')
    parser.add_argument('--state_pred_loss_coeff', type=float, default=1.0, help='weight for state loss')
    ...
    parser.add_argument('--dynamics_layers', nargs='+', type=int, default=[64, 32])
